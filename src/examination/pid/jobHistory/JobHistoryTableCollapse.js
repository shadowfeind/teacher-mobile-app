        ...
        <TableRow>
          ...
          <TableCell>
            <Button
              ...
              onClick={() => updateCollegeHandler(item.IDHRJobHistory)}
            >
            ...
            <Button
              ...
              color="secondary"
              className={classes.button}
              onClick={() => deleteCollegeHandler(item.IDHRJobHistory)}
            >
...
export default JobHistoryTableCollapse;